...
# mycursor.execute("CREATE TABLE users_test (user_id int PRIMARY KEY AUTO_INCREMENT, user_name VARCHAR(50) NOT NULL, password VARCHAR(10) NOT NULL, nike_shirt ENUM('S', 'M', 'L', 'XL'),"
